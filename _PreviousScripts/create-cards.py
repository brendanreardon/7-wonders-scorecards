...
players = 1
for i in range(0,players): # Make a variable called players
...
def wondercards(c):
    ...
    c.drawString(85 - 1*inch,135  - 1*inch,"Iosefa") # write your text
    
    #First Example - Mode Rank
    c.setFillColorRGB(255./256,221./256,113./256) #choose your font colour
    c.setFont("Helvetica", 24) #choose your font type and font size
    c.drawString(390 - 1*inch,135 - 1*inch, str("{0:.0f}".format(mode_rank[0]))) # write your text
